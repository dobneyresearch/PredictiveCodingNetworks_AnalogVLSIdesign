%% PCN chip paper — ArXiv preprint v3
...
\author{Saul Dobney%
  \thanks{Correspondence: saul.dobney@notanant.com.
  Design files, RTL, and simulation scripts are available
  at the project repository upon acceptance.}%
}
...
All design files, RTL, and simulation scripts are open-source, enabling
independent verification of every circuit and algorithmic claim prior to
fabrication.
